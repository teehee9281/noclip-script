-- Credits to 0Zayn and Entitynt

game.StarterGui:SetCore("SendNotification", {Title="Fly Script"; Text="F to toggle, Hold space to ascend, or hold right click and aim where you want to fly to"; Duration=7;})
